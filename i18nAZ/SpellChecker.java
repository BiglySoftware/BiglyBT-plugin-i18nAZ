    ...
    {        
        ...
        for (int i = 0; i < words.length; i++)
        {
            ...
            {           
                ...
                if ((wordWithTrademarkSymbol.equalsIgnoreCase("vuze") == true || wordWithTrademarkSymbol.equalsIgnoreCase("vuzeï¿½") == true) && wordWithTrademarkSymbol.equals("Vuzeï¿½") == false)
                {
                    List<Suggestion> suggestions = new ArrayList<Suggestion>();
                    suggestions.add(new Suggestion("Vuzeï¿½"));                        
                ...
                if(isVuzeWord == false && containsNumeric == false && word.equals("ï¿½") == false &&
                        word.equals("-") == false && 
                        word.equals("'") == false &&
                        word.equals("&") == false &&
                        word.contains("/") == false &&
