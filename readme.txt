...
About
=====
i18nAZ is an BiglyBT plugin for modifying BiglyBT language files (called
MessagesBundle).  Although the plugin is for internationalizing BiglyBT, the
...
Usage
=====
1) (Recommended) Get the CVS version of BiglyBT. This will provide you with
...
=====================
If you saved your language file(s) in BiglyBT program directory, they will 
show up on the "Languages" menu the next you start BiglyBT.
