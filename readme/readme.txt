...
About
=====
i18nAZ is an BiglyBT plugin for modifying BiglyBT language files (called MessagesBundle).


Installation
============
It's recommended that you install the plugin by downloading it from the website 'http://www.biglybt.com/plugins/'

If you can't, you can install it manually as follows:

1) In BiglyBT, choose "Plugins"->"Installation Wizard"
...
3) After completing the wizard, there should be a menu item in the plugin menu.
   If not, restart BiglyBT.


Usage
=====
1) (Recommended) Update BiglyBT. This will provide you with recent MessagesBundles.

2) Start BiglyBT

3) Select View -> Plugins -> Internationalize BiglyBT
...
8) Send your language file to the  BiglyBT people


Viewing Your Language
=====================
To see the changes made ​​to the language files in BiglyBT, restart the application.
